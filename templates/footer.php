			...
			<div class="row">
				<div class="col-lg-3 col-md-6 col-12">
					...
					<div class="single-widget footer-about widget">	
						<div class="logo">
							<div class="img-logo">
								<a class="logo" href="./">
									<img class="img-responsive" src="assets/logo/logoMundoEmpleo.png" alt="logo">
								</a>
							</div>
						</div>
				...
				<div class="col-lg-3 col-md-6 col-12">
					...
					<div class="single-widget f-link widget">
						<h3 class="widget-title">Conoce más</h3>
						<ul>
				...
				<div class="col-lg-3 col-md-6 col-12">
					...
					<div class="single-widget f-link widget">	
						...
						<ul>
							<li><a href="#">Ingreso Candidatos</a></li>
							<li><a href="#">Registro Candidatos</a></li>
							<li><a href="#">Ingreso Empresas </a></li>
							<li><a href="#">Registro Empresas</a></li>
				...
				<div class="col-lg-3 col-md-6 col-12">	
					...
					<div class="single-widget footer_contact widget">	
						...
						<ul class="address-widget-list">
							<li class="footer-mobile-number"><i class="fa fa-phone"></i>+(503) 125-4985-214</li>
							<li class="footer-mobile-number"><i class="fa fa-envelope"></i>info@yoursite.com</li>
							<li class="footer-mobile-number"><i class="fa fa-map-marker"></i>El Salvador</li>
						</ul>
					</div>		
					<!--/ End Footer Contact -->						
				</div>
