...
if($VerificaUsuarioEducacion == 0){
  header('location: educacion?advertencia=1');   
}
...
<main id="main-container">
  ...
  <div class="content py-5 text-center">
    ...
    <a href="educacion-academico" class="btn btn-rounded btn-noborder btn-alt-primary mr-5 mb-5"> <i class="si si-action-undo fa-2x5"> </i> Retroceder</a>
    <a href="habilidades-usuario" class="btn btn-rounded btn-noborder btn-alt-primary mr-5 mb-5"> <i class="si si-action-redo fa-2x5"> </i> Siguiente</a>
  </div>
  <br>
  ...
  <div style="margin-right:2%; margin-left:2%;">
    ...
    <div class="row gutters-tiny">
      ...
      <div class="col-md-7">
        <?php 
        if (!$_GET['id']==null) {
          echo "<form action='Modelos/ModelosExperiencia/ActualizarExperiencia2.php' method='POST'>";
          echo "<input type='hidden' name='IDExperiencia' value='".$_GET['id']."'>";
        }else{
          echo "<form action='Modelos/ModelosExperiencia/NueveExperiencia2.php' method='POST' >";
        }
        ?>
          ...
          <div class="block-header bg-gd-primary">
            ...
            <div class="block-options">
             ...
             if (!$_GET['id']==null) {
              ...
              echo "<a href='experiencia-laboral' class='btn btn-sm btn-alt-primary' style='margin-left: 5px; margin-right: 5px;'>Añadir nuevo</a>";
            }
      ...
      <div class="block-content block-content-full">
       ...
       <div class="form-group row">
        ...
        <div class="col-12">
          <input type="text" class="form-control" id="Puesto" name="Puesto"  value="<?php echo$Cargo ?>" Required placeholder="digite el cargo del trabajo"> 
        </div>
      </div>
         ...
         <table class="table table-borderless table-vcenter">
          ...
          <tbody>
            ...
            while ($item=$stmt3->fetch())
            {
              ...
              <div class='btn-group'>
              <a href='experiencia-laboral?id=".base64_encode($item['IDExperiencia'])."' class='btn btn-sm btn-alt-primary js-tooltip-enabled' data-toggle='tooltip' title='' data-original-title='editar'>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="Modelos/ModelosExperiencia/EliminarExperiencia2.php" method="POST">
