  ...
  try {
                   ...
                   <div class="pb-50">
                    <div class="row justify-content-center text-center">
                      <div class="col-md-10 col-lg-8">
                        ...
                        <h3 class="font-size-h2 font-w300 mt-20" data-toggle="appear" data-class="animated flipInY"  id="titulos" style="color: #0B3486;">Bienvenido al chat <br>mundo empleo! </h3>
                        <p class="text-muted" style="text-align: justify;" data-toggle="appear" data-class="animated fadeInUp">
                         <?php echo $PrimerNombre[0] ." ". $PrimerApellido[0]; ?>: Cualquier tipo de información que esté relacionada con tus datos personales no será compartida ni publicada en esta plataforma. Recuerda respestar a los reclutadores.
                         <br><br>
                         <b style="color: #0B3486; text-align: center;">Nota: Una vez fuera del chat ya no podra enviar mensaje solo ver los mensaje hasta que reclutador te contacte de nuevo podras hacerlo.</b>
                       </p>
     ...
     <div class="js-chat-head block-content block-content-full block-sticky-options  text-center" id="imgbanner">
       ...
       <div class="font-w600 mt-15 mb-5 text-white">
         <span class="text-white">Empresa <br> <b><?php echo $nombreEmpresa ?></b></span>
