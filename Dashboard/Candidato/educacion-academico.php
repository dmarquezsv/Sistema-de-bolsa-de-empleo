...
<main id="main-container">
  ...
  <div class="content py-5 text-center"> 
    ...
    <a href="perfil-candidato" class="btn btn-rounded btn-noborder btn-alt-primary mr-5 mb-5"> <i class="si si-action-undo fa-2x5"> </i> Retroceder</a>
    
    <a href="experiencia-laboral" class="btn btn-rounded btn-noborder btn-alt-primary mr-5 mb-5"> <i class="si si-action-redo fa-2x5"> </i> Siguiente</a>
  </div>
  <br>
  ...
  <div style="margin-right:2%; margin-left:2%;">
    ...
    <div class="row gutters-tiny">
      ...
      <div class="col-md-7">
        <?php 
        if (!$_GET['id']==null) {
          echo "<form action='Modelos/ModelosEducacion/ActualizarEducacion2.php' method='POST' >";
          echo "<input type='hidden' name='IDEducacion' value='".$_GET['id']."'>";
        }else{
          echo "<form action='Modelos/ModelosEducacion/NuevaEducacion2.php' method='POST' >";
        }
        ?>
          ...
          <div class="block-header bg-gd-primary">
            ...
            <div class="block-options">
              ...
              <?php if (!$_GET['id']==null) {
                ...
                echo "<a href='educacion-academico' class='btn btn-sm btn-alt-primary' style='margin-left: 5px; margin-right: 5px;'>Añadir nuevo</a>";
              } ?> 
    ...
    <div class="form-group row">
      ...
      <div class="col-12">
       <select class='form-control' name="NivelEstudio" id="NivelEstudio" required>
        <?php if (!$_GET['id']==null) {
          echo "<option selected value=".$NivelEstudio.">".$NivelEstudio."</option>";
        }else{
         ...
         <table class="table table-borderless table-vcenter">
          ...
          <tbody>
            ...
            while ($item=$stmt3->fetch())
            {
              ...
              <div class='btn-group'>
              <a href='?id=".base64_encode($item['IDEducacion'])."' class='btn btn-sm btn-alt-primary js-tooltip-enabled' data-toggle='tooltip' title='' data-original-title='editar'>
              <i class='fa fa-pencil'> </i> Editar
              </a>
              <button id='val".$n."' value=".base64_encode($item['IDEducacion'])." data-toggle='modal' data-target='#exampleModal' class='btn btn-sm btn-alt-primary js-tooltip-enabled' data-toggle='tooltip' title='' data-original-title='eliminar'> <i class='fa fa-times'></i> Eliminar</button>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="Modelos/ModelosEducacion/EliminarEducacion2.php" method="POST">
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    $('#especialidad').on('click', function() {
     ...
     $("#resultEstudio").html('<div class="form-group row"><label class="col-12" for="ecom-product-meta-title">Especialidad / Curso *</label><div class="col-12"><input type="text" class="form-control" id="Especialidad" name="Especialidad"  value="<?php echo $Especialidad; ?>" required  minlength="10" maxlength="100" title="Letras y números. Tamaño mínimo: 5. Tamaño máximo: 100" required placeholder="Máximo 100 palabras"></div></div>');
     $("#resultCarrera1").html("");
