...
if($VerificaUsuarioExperiencia == 0){
	echo "<script>location.href='experiencia?advertencia=1';</script>";
}
...
<main id="main-container">
	...
	<div style="margin-right:2%; margin-left:2%;">
		...
		<div class="content py-5 text-center">
			<br>
			<a href="experiencia?notificar=1" class="btn btn-rounded btn-noborder btn-alt-primary mr-5 mb-5"> <i class="si si-action-undo fa-2x5"> </i> Retroceder</a>
			<a href="referencia?notificar=1" class="btn btn-rounded btn-noborder btn-alt-primary mr-5 mb-5"> <i class="si si-action-redo fa-2x5"> </i> Siguiente</a>
		</div>
			...
			<div class="col-md-7">
				...
				<div class="block block-rounded block-themed">
					<div class="block-header bg-gd-primary">
						...
						<div class="block-options">
							<form action="Modelos/ModelosIdiomas/NuevoIdioma.php" method="POST">
				...
				<div class="block block-rounded block-themed">
					<div class="block-header bg-gd-primary">
						...
						<div class="block-options">
							<form action="Modelos/ModelosHabilidades/NuevaHabilidad.php" method="POST">
				...
				<div class="block block-rounded block-themed">
					<div class="block-header bg-gd-primary">
						...
						<div class="block-options">
							<form action="Modelos/ModelosTecnicos/NuevaTecnica.php" method="POST"> 
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<form action="Modelos/ModelosIdiomas/EliminarIdioma.php" method="POST">
			...
			<div class="modal fade" id="exampleModal2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="modal-body">
							<p>Seguro que desea eliminar</p>
							<form action="Modelos/ModelosHabilidades/EliminarHabilidad.php" method="POST">
			...
			<div class="modal fade" id="exampleModal3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="modal-body">
							<p>Seguro que desea eliminar</p>
							<form action="Modelos/ModelosTecnicos/EliminarTecnica.php" method="POST">
									...
									<div class="row justify-content-center text-center">
										<div class="col-md-10 col-lg-8">
											...
											<p class="text-muted" style="text-align: justify;" data-toggle="appear" data-class="animated fadeInUp">
												<?php echo $PrimerNombre[0] ." ". $PrimerApellido[0]; ?>: Deberás agregar tus habilidades ya sea en idiomas , habilidades personales por lo tanto son <b style="color: red;">OBLIGATORIAS</b> para continuar el proceso y habilidades técnicas es opcional. 
												<br><br>
												Solo se puede añadir 5 de cada de uno por lo tanto ya no podrás agregar otro, Si desea agregar deberá eliminar.
												<br><br>
												<b style="color: #0B3486;">Nota: Una vez agreado sus habilidades deberá dar clic en el botón siguiente para añadir sus referencias.</b>
											</p>
								...
								<div class="pb-50">
									<div class="row justify-content-center text-center">
										<div class="col-md-10 col-lg-8">
											...
											<p class="text-muted" style="text-align: justify;" data-toggle="appear" data-class="animated fadeInUp">
												<?php echo $PrimerNombre[0] ." ". $PrimerApellido[0]; ?>: Deberás agregar por lo <b>menos un  idioma y una habilidad personal</b> ya que es requesito completar el formulario para  poder continuar con el proceso. 
												<br><br>
												<b style="color: #0B3486;">Nota: Una vez agreado sus habilidades deberá dar clic en el botón siguiente para añadir sus referencias.</b>
											</p>
