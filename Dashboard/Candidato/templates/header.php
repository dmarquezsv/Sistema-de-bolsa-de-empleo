        ...
        <div class="content-header-section">
            ...
            <div class="btn-group" role="group">
                <button type="button" class="btn btn-rounded btn-dual-secondary" id="page-header-user-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <span class="d-none d-sm-inline-block">
                        <b><?php echo $PrimerNombre[0] ." ". $PrimerApellido[0];?></b>
                ...
                <div class="dropdown-menu dropdown-menu-right min-width-200" aria-labelledby="page-header-user-dropdown">
                    ...
                    <a class="dropdown-item" href="actualizar-cuenta.php">
                        <i class="si si-user mr-5"></i> Perfil usuario
                    </a>
                    ...
                    <a class="dropdown-item" href="chats-empresas">
                        <i class="si si-note mr-5"></i> chats 
                    </a>
                    ...
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="../salir-view-candidato.php">
            ...
            <div class="btn-group" role="group">
                <button type="button" class="btn btn-rounded btn-dual-secondary" id="page-header-notifications" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <span class="badge badge-primary badge-pill" id="cuantas"></span>
                </button>
