            ...
            <div class="block-content">
                ...
                <div class="float-left">
                    ...
                    <ul style="text-align: left;">
                        <li><a href="#" class="text-white"> <b>Búsqueda de Empleos</b> </a></li>
                        <br>
                        <li><a href="#" class="text-white"> <b>Quienes Somos</b> </a></li>
                        <br>
                        <li><a href="#" class="text-white"> <b>Mapa del Sitio</b> </a></li>
                        <br>
                        <li><a href="#" class="text-white"> <b>Blog</b> </a></li>
                        <br>
                        <li><a href="#" class="text-white"> <b>Condiciones</b> </a></li>
                        <br>
                        <li><a href="#" class="text-white"> <b>Derechos</b> </a></li>
                    </ul>
                </div>
        ...
        <div class="col-md-3 ml-auto">
            <div class="block-content">
             ...
             <div class="float-left">
                ...
                <ul style="text-align: left;">
                    <li><a href="#" class="text-white"> <b>Políticas</b> </a></li>
                    <br>
                    <li><a href="#" class="text-white"> <b>Contáctanos</b> </a></li>
                    <br>
                    <li><a href="#" class="text-white"> <b>Preguntas Candidatos</b> </a></li>
                    <br>
                    <li><a href="#" class="text-white"> <b>Registros Cuentas</b> </a></li>
                    <br>
                    <li><a href="#" class="text-white"> <b>Sugerencias</b> </a></li>
                    <br>
    ...
    <div class="col-md-3 ml-auto">
        ...
        <div class="block-content">
            <div class="float-left">
                ...
                <ul style="text-align: left;">
                    <li><a href="#" class="text-white"> <b>Preguntas Reclutadores</b> </a></li>
                    <br>
                    <li><a href="#" class="text-white"> <b>Registros Empresas</b> </a></li>
                    <br>
                    <li><a href="#" class="text-white"> <b>Ingresos Empresas</b> </a></li>
                    <br>
                    <li><a href="#" class="text-white"> <b>Directorios de Empresas</b> </a></li>
                    <br>
                    <li><a href="#" class="text-white"> <b>Reclutamiento Internacional</b> </a></li>
                    <br>
                    <li><a href="#" class="text-white"> <b>Contate con nosotros</b> </a></li>
                </ul>
            </div>
        </div>
