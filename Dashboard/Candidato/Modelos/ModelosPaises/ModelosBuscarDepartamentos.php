...
if (isset($_POST['consulta'])) {
	...
	if ($stmt->rowCount()>0){
		...
		$salida.="<select name='IDDepartemento' style='width: 100%;' class='form-control' >";
	...
	$salida.="<label class='col-12' for='Dapartamento'>Seleccione su departamento de origen*</label>";
	$salida.= '<input type="text" name="buscardepa" id="bucardepa"  class="form-control" disabled placeholder="seleccione un departamento" required>';
	echo $salida;
}
