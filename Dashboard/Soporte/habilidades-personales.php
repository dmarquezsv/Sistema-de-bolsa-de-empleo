...
?>
<title>Soporte | habilidades personales</title>
<?php 
    ...
    <div class="">
      <div class="content content-top text-center overflow-hidden">
        <div class="pt-40 pb-20">
          <h2 class="h4 font-w400  invisible" id="titulos"  style="color: white;" data-toggle="appear" data-class="animated fadeInUp">Habilidades personales</h2>
        </div>
      </div>
    </div>
  </div>
  ...
  <div style="margin-right:2%; margin-left:2%;">
    ...
    <div class="bg-body-light border-b">
      <div class="content py-5 text-center">
        <nav class="breadcrumb bg-body-light mb-0">
          ...
          <span class="breadcrumb-item active"><b>habilidades personales</b></span>
   ...
   <div class="block block-themed block-rounded">
    <div class="block-header " style="background: #0B3486;">
      <h3 class="block-title"><b>Control de las habilidades personales</b></h3>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Agregar una habilidad personal</h5>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="form-group">
                  ...
                  <label for="" class="col-form-label">Nombre de la habilidad personal:</label>
...
<div class="modal fade" id="modalCRUD" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Actualizar habilidad personal</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="form-group">
                  ...
                  <label for="" class="col-form-label">Nombre de la habilidad:</label>
    ...
    <div class="modal-content">
      <div class="block block-themed block-transparent mb-0">
        <div class="block-header bg-primary-dark">
          <h3 class="block-title">Eliminar habilidad personal</h3>
          <div class="block-options">
...
<script type="text/javascript">
  ...
  function mostrar(){
   ...
   tablasInformacion = $('#resultTablas').DataTable({  
    "ajax":{            
      "url": "Modelos/habilidadespersonales/mostrar-habilidades.personales.php", 
      "dataSrc":""
    },
    "columns":[
    {"data": "IDHabilidades"},
 ...
 $('#btnAgregar').on('click', function() {
   ...
   $.ajax({
    url: 'Modelos/habilidadespersonales/agregar-habilidad-personal.php' ,
    type: 'post' ,
 ...
 $('#btnActualizar').on('click', function() {
  ...
  $.ajax({
    url: 'Modelos/habilidadespersonales/actualizar-habilidades-personales.php' ,
    type: 'post' ,
 ...
 $('#btnEliminar').on('click', function() {
  ...
  $.ajax({
    url: 'Modelos/habilidadespersonales/eliminiar-habilidades.personales.php' ,
    type: 'post' ,
    data: {id:id},
    beforeSend: function() {   $("#resultestatus2").html('<i class="fa fa-sun-o fa-spin text-warning"></i>');}
  })
  .done(function(response){
    ...
    swal({title:'éxito',text:'Se ha eliminado la habilidades perssonal',type:'success'  , timer: 2000});
