...
?>
<title>Soporte | Seguimientos</title>
<?php 
    ...
    <div class="">
      <div class="content content-top text-center overflow-hidden">
        <div class="pt-40 pb-20">
          <h2 class="h4 font-w400  invisible" id="titulos"  style="color: white;" data-toggle="appear" data-class="animated fadeInUp">Seguimientos</h2>
        </div>
      </div>
    </div>
  </div>
  ...
  <div style="margin-right:2%; margin-left:2%;">
    ...
    <div class="bg-body-light border-b">
      <div class="content py-5 text-center">
        <nav class="breadcrumb bg-body-light mb-0">
          ...
          <span class="breadcrumb-item active"><b>Seguimientos</b></span>
    ...
    <div class="block block-themed block-rounded">
      <div class="block-header " style="background: #0B3486;">
        <h3 class="block-title"><b>Control de los seguimientos</b></h3>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Agregar tipo de seguimiento</h5>
              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="form-group">
                    ...
                    <label for="" class="col-form-label">tipo del seguimiento:</label>
                    <input type="text" class="form-control" id="Nombres" placeholder="Nombres del seguimiento">
              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="form-group">
                    ...
                    <label for="" class="col-form-label">nombre del seguimiento:</label>
      ...
      <div class="modal-content">
        <div class="block block-themed block-transparent mb-0">
          <div class="block-header bg-primary-dark">
            <h3 class="block-title">Eliminar tipo de seguimiento</h3>
            <div class="block-options">
            ...
            <div class="block">
              <div class="block-content block-content-full">
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="form-group">
                      <label for="" class="col-form-label">Nombres del seguimiento:</label>
  ...
  <script type="text/javascript">
    ...
    function mostrar(){
     ...
     tablasInformacion = $('#resultTablas').DataTable({  
      "ajax":{            
        "url": "Modelos/seguimientos/mostrar-seguimientos.php", 
        "dataSrc":""
      },
      "columns":[
      {"data": "IDSeleccion"},
   ...
   $('#btnAgregar').on('click', function() {
     ...
     $.ajax({
      url: 'Modelos/seguimientos/agregar-seguimientos.php' ,
      type: 'post' ,
     ...
     .done(function(response){
      ...
      swal({title:'éxito',text:'Se ha agregado el seguimiento',type:'success'  , timer: 2000});
      $('#Nombres').val("");
   ...
   $('#btnActualizar').on('click', function() {
    ...
    $.ajax({
      url: 'Modelos/seguimientos/actualizar-seguimientos.php' ,
      type: 'post' ,
    ...
    .done(function(response){
      ...
      swal({title:'éxito',text:'Se ha actualizado el seguimiento',type:'success'  , timer: 2000});
      $('#Nombres').val("");
      $('#Apellidos').val("");
      $('#email').val("");
      $("#resultestatus2").html('');
   ...
   $('#btnEliminar').on('click', function() {
    ...
    $.ajax({
      url: 'Modelos/seguimientos/eliminar-seguimientos.php' ,
      type: 'post' ,
      data: {id:id},
      beforeSend: function() {   $("#resultestatus2").html('<i class="fa fa-sun-o fa-spin text-warning"></i>');}
    })
    .done(function(response){
      ...
      swal({title:'éxito',text:'Se ha eliminado el seguimiento',type:'success'  , timer: 2000});
