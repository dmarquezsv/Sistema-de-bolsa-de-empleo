...
?>
<title>Soporte | facultades</title>
<?php 
...
<main id="main-container">
    ...
    <div class="">
      <div class="content content-top text-center overflow-hidden">
        <div class="pt-40 pb-20">
          <h2 class="h4 font-w400  invisible" id="titulos"  style="color: white;" data-toggle="appear" data-class="animated fadeInUp">Facultades</h2>
        </div>
      </div>
    </div>
  </div>
  ...
  <div style="margin-right:2%; margin-left:2%;">
    ...
    <div class="bg-body-light border-b">
      <div class="content py-5 text-center">
        <nav class="breadcrumb bg-body-light mb-0">
          ...
          <span class="breadcrumb-item active"><b>Facultades</b></span>
    ...
    <div class="content py-5 text-center">
     ...
     <a href="carreras" class="btn btn-rounded btn-noborder btn-alt-primary mr-5 mb-5"> <i class="si si-action-redo fa-2x5"> </i>Carreras</a>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Agregar una facultad</h5>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="Nombres" placeholder="Nombres de la facultad">
...
<div class="modal fade" id="modalCRUD" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Actualizar facultadad</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="form-group">
                  ...
                  <label for="" class="col-form-label">Nombre de la facultad:</label>
    ...
    <div class="modal-content">
      <div class="block block-themed block-transparent mb-0">
        <div class="block-header bg-primary-dark">
          <h3 class="block-title">Eliminar facultadad</h3>
          <div class="block-options">
...
<script type="text/javascript">
  ...
  function mostrar(){
   ...
   tablasInformacion = $('#resultTablas').DataTable({  
    "ajax":{            
      "url": "Modelos/facultades/mostrar-facultades.php", 
      "dataSrc":""
    },
    "columns":[
    {"data": "IDFacultates"},
 ...
 $('#btnAgregar').on('click', function() {
   ...
   $.ajax({
    url: 'Modelos/facultades/agregar-facultad.php' ,
    type: 'post' ,
 ...
 $('#btnActualizar').on('click', function() {
  ...
  $.ajax({
    url: 'Modelos/facultades/actualizar-facultades.php' ,
    type: 'post' ,
 ...
 $('#btnEliminar').on('click', function() {
  ...
  alert(id);
  $.ajax({
    url: 'Modelos/facultades/eliminar-facultades.php' ,
    type: 'post' ,
    data: {id:id},
    beforeSend: function() {   $("#resultestatus2").html('<i class="fa fa-sun-o fa-spin text-warning"></i>');}
  })
