...
?>
<title>Soporte | habilidades</title>
<?php 
...
<main id="main-container">
    ...
    <div class="">
      <div class="content content-top text-center overflow-hidden">
        <div class="pt-40 pb-20">
          <h2 class="h4 font-w400  invisible" id="titulos"  style="color: white;" data-toggle="appear" data-class="animated fadeInUp">Habilidades</h2>
        </div>
      </div>
    </div>
  </div>
  ...
  <div style="margin-right:2%; margin-left:2%;">
    ...
    <div class="bg-body-light border-b">
      <div class="content py-5 text-center">
        <nav class="breadcrumb bg-body-light mb-0">
          ...
          <span class="breadcrumb-item active"><b>experiencia técnica</b></span>
    ...
    <div class="content py-5 text-center">
      ...
      <a href="habilidades-personales" class="btn btn-rounded btn-noborder btn-alt-primary mr-5 mb-5"> <i class="si si-action-redo fa-2x5"> </i>Habilidades personales</a>

      <a href="tiempos-experiencia" class="btn btn-rounded btn-noborder btn-alt-primary mr-5 mb-5"> <i class="si si-action-redo fa-2x5"> </i>tiempos de experiencias</a>
    ...
    <div class="block block-themed block-rounded">
      <div class="block-header " style="background: #0B3486;">
        <h3 class="block-title"><b>Control de las experiencia técnica</b></h3>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Agregar una experiencia técnica</h5>
  ...
  <div class="modal fade" id="modalCRUD" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Actualizar experiencia técnica</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
      ...
      <div class="modal-content">
        <div class="block block-themed block-transparent mb-0">
          <div class="block-header bg-primary-dark">
            <h3 class="block-title">Eliminar experiencia técnica</h3>
            <div class="block-options">
  ...
  <script type="text/javascript">
    ...
    function mostrar(){
     ...
     tablasInformacion = $('#resultTablas').DataTable({  
      "ajax":{            
        "url": "Modelos/experienciatecnica/mostrar-experiencia-tecnica.php", 
        "dataSrc":""
      },
      "columns":[
      {"data": "IDTipo"},
   ...
   $('#btnAgregar').on('click', function() {
     ...
     $.ajax({
      url: 'Modelos/experienciatecnica/agregar-experiencia-tecnica.php' ,
      type: 'post' ,
   ...
   $('#btnActualizar').on('click', function() {
    ...
    $.ajax({
      url: 'Modelos/experienciatecnica/actualizar-experiencia-tecnica.php' ,
      type: 'post' ,
    ...
    .done(function(response){
      ...
      swal({title:'éxito',text:'Se ha actualizado la  experiencia técnica ',type:'success'  , timer: 2000});
      $('#Nombres').val("");
      $('#Apellidos').val("");
      $('#email').val("");
      $("#resultestatus2").html('');
   ...
   $('#btnEliminar').on('click', function() {
    ...
    $.ajax({
      url: 'Modelos/experienciatecnica/eliminar-experiencia-tecnica.php' ,
      type: 'post' ,
      data: {id:id},
      beforeSend: function() {   $("#resultestatus2").html('<i class="fa fa-sun-o fa-spin text-warning"></i>');}
    })
