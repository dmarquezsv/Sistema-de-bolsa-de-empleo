...
$stmt = $Conexion->ejecutar_consulta_simple_Where($sql , base64_decode($_GET['iduser']));
  ...
  <div style="margin-right:2%; margin-left:2%;">
    ...
    <div class="content py-5 ">
      ...
      <div class="text-center">
        <a href="empresa?<?php echo $_GET['iduser'];?>&idempresa=<?php echo $_GET['idempresa']?>" class="btn btn-rounded btn-noborder btn-alt-primary mr-5 mb-5"> <i class="si si-action-undo fa-2x5"> </i> Retroceder</a>
