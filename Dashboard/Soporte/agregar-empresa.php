...
$sql="INSERT INTO `usuarios_cuentas` (`Nombre`, `Apellidos`, `Correo`, `Password`, `Token`, `Cargo`) VALUES (:Nombre,:Apellidos,:Correo,:Password, :Token , 'Empresa') ";
