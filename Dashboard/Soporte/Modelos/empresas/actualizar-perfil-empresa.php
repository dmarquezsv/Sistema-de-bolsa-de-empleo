...
if (isset($_POST['Guardar'])) {
	...
	$stmt->bindParam('Expira', $fecha , PDO::PARAM_STR);
	...
	if ($stmt->execute()){
		...
		header('Location: ../../actualizar-perfil-empresa?iduser='.base64_encode($IDusuario).'&idempresa='.$IdEmpresa);
	}else{
