...
?>
<title>Soporte | Tipo empresas</title>
<?php 
    ...
    <div class="">
      <div class="content content-top text-center overflow-hidden">
        <div class="pt-40 pb-20">
          ...
          <h2 class="h4 font-w400  invisible" id="titulos"  style="color: white;" data-toggle="appear" data-class="animated fadeInUp">Tipos de empresas</h2>
        </div>
      </div>
    </div>
  </div>
  ...
  <div style="margin-right:2%; margin-left:2%;">
    ...
    <div class="bg-body-light border-b">
      <div class="content py-5 text-center">
        <nav class="breadcrumb bg-body-light mb-0">
          ...
          <span class="breadcrumb-item active"><b>Tipos de empresas</b></span>
    ...
    <div class="block block-themed block-rounded">
      <div class="block-header " style="background: #0B3486;">
        <h3 class="block-title"><b>Tipos de empresas</b></h3>
      ...
      <div class="modal-content">
        <div class="block block-themed block-transparent mb-0">
          <div class="block-header bg-primary-dark">
            <h3 class="block-title">Eliminar categoria</h3>
            <div class="block-options">
  ...
  <script type="text/javascript">
    ...
    function mostrar(){
     ...
     tablasInformacion = $('#resultTablas').DataTable({  
      "ajax":{            
        "url": "Modelos/tipos-empresas/mostrar-categorias-empresas.php", 
        "dataSrc":""
      },
      "columns":[
      {"data": "IDTipoEmpresa"},
