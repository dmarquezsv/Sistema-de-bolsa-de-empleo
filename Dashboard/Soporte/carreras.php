...
<main id="main-container">
    ...
    <div class="">
      <div class="content content-top text-center overflow-hidden">
        <div class="pt-40 pb-20">
          <h2 class="h4 font-w400  invisible" id="titulos"  style="color: white;" data-toggle="appear" data-class="animated fadeInUp">Carreras</h2>
        </div>
      </div>
    </div>
  </div>
  ...
  <div style="margin-right:2%; margin-left:2%;">
    ...
    <div class="bg-body-light border-b">
      <div class="content py-5 text-center">
        <nav class="breadcrumb bg-body-light mb-0">
          ...
          <span class="breadcrumb-item active"><b>Carreras</b></span>
    ...
    <div class="content py-5 text-center">
      <br>
      <a href="facultades" class="btn btn-rounded btn-noborder btn-alt-primary mr-5 mb-5"> <i class="si si-action-undo fa-2x5"> </i> Retroceder</a>  
    ...
    <div class="block block-themed block-rounded">
      <div class="block-header " style="background: #0B3486;">
        <h3 class="block-title"><b>Control de las facultades</b></h3>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Agregar una carrera</h5>
              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="form-group">
                    ...
                    <label>Seleccione la facultadad</label>
            ...
            <div class="row">
              <div class="col-lg-12">
                <div class="form-group">
                  ...
                  <label for="" class="col-form-label">Nombre de la carrera:</label>
    ...
    <div class="modal-content">
      <div class="block block-themed block-transparent mb-0">
        <div class="block-header bg-primary-dark">
          <h3 class="block-title">Eliminar Carrera</h3>
          <div class="block-options">
...
<script type="text/javascript">
 ...
 $('#btnAgregar').on('click', function() {
  ...
  $.ajax({
    url: 'Modelos/carreras/agregar-carrera.php' ,
    type: 'post' ,
 ...
 $('#btnActualizar').on('click', function() {
  ...
  $.ajax({
    url: 'Modelos/carreras/actualizar-carrera.php' ,
    type: 'post' ,
 ...
 $('#btnEliminar').on('click', function() {
  ...
  $.ajax({
    url: 'Modelos/carreras/eliminar-carrera.php' ,
    type: 'post' ,
    data: {id:id},
    beforeSend: function() {   $("#resultestatus2").html('<i class="fa fa-sun-o fa-spin text-warning"></i>');}
  })
  .done(function(response){
    ...
    swal({title:'éxito',text:'Se ha eliminado la facultadad',type:'success'  , timer: 2000});
