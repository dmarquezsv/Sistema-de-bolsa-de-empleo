...
?>
<title>Soporte | Cargos de trabajos</title>
<?php 
...
<main id="main-container">
    ...
    <div class="">
      <div class="content content-top text-center overflow-hidden">
        <div class="pt-40 pb-20">
          ...
          <h2 class="h4 font-w400  invisible" id="titulos"  style="color: white;" data-toggle="appear" data-class="animated fadeInUp">Cargos de trabajo</h2>
        </div>
      </div>
    </div>
  </div>
  ...
  <div style="margin-right:2%; margin-left:2%;">
    ...
    <div class="bg-body-light border-b">
      <div class="content py-5 text-center">
        <nav class="breadcrumb bg-body-light mb-0">
          ...
          <span class="breadcrumb-item active"><b>Cargos de trabajos</b></span>
    ...
    <div class="content py-5 text-center">
      <br>
      <a href="areas-trabajos" class="btn btn-rounded btn-noborder btn-alt-primary mr-5 mb-5"> <i class="si si-action-undo fa-2x5"> </i> Retroceder</a>
    </div>
    <br>
    ...
    <div class="block block-themed block-rounded">
      <div class="block-header " style="background: #0B3486;">
        <h3 class="block-title"><b>Control de las cargos de trabajos</b></h3>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Agregar un cargo de trabajos</h5>
              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="form-group">
                    ...
                    <select class="form-control"  id="facultadad" style="width: 100%;" >
                   ...
                   <label for="" class="col-form-label">Nombre  del cargo:</label>
                   <input type="text" class="form-control" id="carrera" placeholder="Nombres de la facultad">
...
<div class="modal fade" id="modalCRUD" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">Actualizar el cargo de trabajos</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
    ...
    <div class="modal-content">
      <div class="block block-themed block-transparent mb-0">
        <div class="block-header bg-primary-dark">
          <h3 class="block-title">Eliminar cargo de trabajo</h3>
          <div class="block-options">
              ...
              <div class="row">
                <div class="col-lg-12">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="nombreCarrera" disabled>
...
<script type="text/javascript">
  ...
  function mostrar(){
   ...
   tablasInformacion = $('#resultTablas').DataTable({  
    "ajax":{            
      "url": "Modelos/cargos-trabajos/mostrar-cargos-trabajos.php", 
      "dataSrc":""
    },
    "columns":[
    {"data": "IDDesempenado"},
 ...
 $('#btnAgregar').on('click', function() {
  ...
  var idFacultad = $('#facultadad option:selected');
  var idFacultadseleccionado = idFacultad.val();

  var  Nombres =$('#carrera').val();


  $.ajax({
    url: 'Modelos/cargos-trabajos/agregar-cargos-trabajos.php' ,
    type: 'post' ,
    data: {Nombres:Nombres , idFacultadseleccionado:idFacultadseleccionado},
    beforeSend: function() {   $("#resultestatus2").html('<i class="fa fa-sun-o fa-spin text-warning"></i>');}
  })
  .done(function(response){

    swal({title:'éxito',text:'Se ha agregado el cargo de trabajo',type:'success'  , timer: 2000});
    $('#carrera').val("");
    $("#facultadad").val($("#pais option:first").val());
 ...
 $('#btnActualizar').on('click', function() {
  ...
  $.ajax({
    url: 'Modelos/cargos-trabajos/actualizar-cargos-trabajos.php' ,
    type: 'post' ,
  ...
  .done(function(response){
    ...
    swal({title:'éxito',text:'Se ha actualizado el cargo de trabajo',type:'success'  , timer: 2000});
    $('#Nombres').val("");
    $('#Apellidos').val("");
    $('#email').val("");
    $("#resultestatus2").html('');
 ...
 $('#btnEliminar').on('click', function() {
  ...
  $.ajax({
    url: 'Modelos/cargos-trabajos/eliminar-cargos-trabajos.php' ,
    type: 'post' ,
    data: {id:id},
    beforeSend: function() {   $("#resultestatus2").html('<i class="fa fa-sun-o fa-spin text-warning"></i>');}
  })
  .done(function(response){
    ...
    swal({title:'éxito',text:'Se ha eliminado el cargo',type:'success'  , timer: 2000});
