...
$sql3= "SELECT TE.IDTipoEmpresa,TE.Area AS 'TipoEmpresa' ,P.IDPais ,P.Nombre AS 'Pais' , PD.IDDepartamento,PD.Nombre AS 'Departamento' , EP.Nombre , `lugar`,`Mapa`,`Descripcion` , `Email` , `CodigoPostal` , `Telefono` ,`Celular` ,`facebook` ,`instagram` ,`whatsapp` ,`youtube` ,`logo` ,`paginaweb` , `Confidencial` , `razonSocial` , `Expira` , `estado` FROM empresa_perfil EP INNER JOIN soporte_tipo_empresa TE ON EP.IDTipoEmpresa = TE.IDTipoEmpresa LEFT JOIN soporte_paises P ON EP.IDPais = P.IDPais LEFT JOIN soporte_paises_departamento PD ON EP.IDDepartamento = PD.IDDepartamento WHERE IDUsuario = ?";
...
<main id="main-container">
  ...
  <div style="margin-right:2%; margin-left:2%;" data-toggle="appear" data-class="animated bounceInLeft">
    <div class="row gutters-tiny">
      <!-- Basic Info -->
      <div class="col-md-7">
        <form action="Modelos/empresas/actualizar-perfil-empresa.php" method="POST">
          <input type="hidden" name="Iduser" id="Iduser" value="<?php echo$IDUser; ?>"> 
          <input type="hidden" name="IdEmpresa" id="IdEmpresa" value="<?php echo $_GET['idempresa']; ?>"> 
          <div class="block block-rounded block-themed">
            <div class="block-header bg-gd-primary">
              <h3 class="block-title">Información de la empresa </h3>
              <div id="status"></div>
              <div class="block-options">
                <a href="empresa?iduser=<?php echo $_GET['iduser']; ?>=&idempresa=<?php echo $_GET['idempresa']; ?>" class="btn btn-sm btn-alt-primary">Retroceder</a>
            ...
            <div class="block-content block-content-full">
             ...
             <div class="form-group row">
              <label class="col-12">Fecha limite para  ocupar la plataforma *</label>
              <div class="col-12">
               <input type="date" class="form-control" name="fechaEstablecida"  id="fechaEstablecida"  value="<?php echo$expira; ?>" required placeholder="Por favor, ingrese la fecha">
             </div>
           </div>

           <div class="form-group row">
            <label class="col-12">Estado de la empresa *</label>
            <div class="col-12">
             ...
             <select class="form-control" name="estado" id="estado">
               ...
               <option value="Vencido">Descativar la empresa</option>
             </select>
