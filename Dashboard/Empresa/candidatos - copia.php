...
$sql3 = "SELECT `IDDesempenado` , `nombre` FROM `soporte_cargos_desempenado` ORDER BY `soporte_cargos_desempenado`.`nombre` ASC";
...
$sql5 = "SELECT `IDDesempenado` , `nombre` FROM `soporte_cargos_desempenado` ORDER BY `soporte_cargos_desempenado`.`nombre` ASC";
...
$sql8 = "SELECT * FROM `soporte_tipo_empresa` ORDER BY `soporte_tipo_empresa`.`Area` ASC ";
$stmt8 = $Conexion->ejecutar_consulta_simple($sql8);
...
$sql10 = "SELECT * FROM `soporte_tipo_empresa` ORDER BY `soporte_tipo_empresa`.`Area` ASC ";
$stmt10 = $Conexion->ejecutar_consulta_simple($sql10);
...
<div class="modal fade" id="modal-terms2" tabindex="-1" role="dialog" aria-labelledby="modal-terms" aria-hidden="true">
          ...
          <div class="block">
            <div class="block-content block-content-full">
             ...
             <div class="col-sm">
              ...
              <input type="number" name="salariomayor" id="salariomayor" min="1" max="100" placeholder="Mayor" class="form-control">
 ...
 <div class="row">
  ...
  <div class="col-sm"> 
    <label>Área estudios</label>
    <select class="js-select2 form-control" id="example-select-carrera" name="carrera" style="width: 100%;" data-placeholder="Selecciona una opción">
      <option></option>
      <?php 
...
<div class="col-sm"> 
  <label>Área estudios</label>
  <select class="js-select2 form-control" id="example-select-carrera2" name="carrera" style="width: 100%;" data-placeholder="Selecciona una opción">
    <option></option>
    <?php 
    while ($item2=$stmt5->fetch())
    {
     echo "<option value=".$item['IDDesempenado'].">".$item['nombre']."</option>";
   }
...
<div class="col-sm">
 ...
 <select class="js-select2 form-control" id="example-selectTipoEmpresa" name="selectTipoEmpresa" style="width: 100%;" data-placeholder="Selecciona una opción">
  <option></option>
...
<div class="col-sm">
 ...
 <label>Tipo de empresa</label>
 <select class="js-select2 form-control" id="example-selectTipoEmpresa2" name="selectTipoEmpresa" style="width: 100%;" data-placeholder="Selecciona una opción" >
  <option></option>

  <?php 
  while ($item=$stmt10->fetch())
  {
   echo "<option value=".$item['IDTipoEmpresa'].">".$item['Area']."</option>";
 }
