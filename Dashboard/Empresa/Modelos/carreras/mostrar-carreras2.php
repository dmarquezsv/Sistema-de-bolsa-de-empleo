...
if (isset($_POST['consulta'])) {
	...
	$salida.="<select name='carrera2'  id='carrera2' style='width: 100%;' class='form-control'>";
	...
	$salida.="<select name='carrera2'  id='carrera2' style='width: 100%;' class='form-control' disabled>";
