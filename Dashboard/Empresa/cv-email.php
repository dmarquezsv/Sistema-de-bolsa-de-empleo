   ...
   //file_put_contents($filename, $pdf);
	//$dompdf->stream($filename);
			...
			try {
			    ...
			    <p style="margin: 0; text-align: justify;">Hola '.$NombresUser.' te saluda el equipo de Mundo Empleo:  <br><br>Hemos recibido un pedido para enviarte curriculum vitae en pdf. Si no has iniciado este pedido, puedes simplemente ignorar este mensaje y ninguna acción será tomada. <br> </p>
			    ...
			    <center>
			    <a href="https://mundoempleosca.com/Dashboard/Candidato/cv?id='.base64_encode($IDUser).'" target="_blank" rel="noopener noreferrer" data-auth="NotApplicable" style="display:inline-block; min-width:250px; font-family:Tahoma,Arial,sans-serif; font-size:18px; font-weight:bold; color:#0B3486; line-height:50px; text-align:center; text-decoration:none; background-color:#FCC201; border-radius:50px; padding:16px 24px; line-height:1">Ver Perfil</a>
			    </center>
