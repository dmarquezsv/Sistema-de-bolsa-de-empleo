...
class EnviarCorreos 
{
	...
	public function EnviarVerfificacion($Nombre, $emial , $Token){
		...
		try {
			    ...
			    $mail->Subject = 'Bienvenido a Mundo Empleo | Activa tu cuenta '.$Nombre.'';
