...
$paisEvaluar = $_POST['paisEvaluar'];
$cargoEvaluar = $_POST['cargoEvaluar'];
...
try {		
	          $mail = new PHPMailer(true);
			    ...
			    <h1 style="font-size: 24px; margin: 0; text-align: center;">Mensaje de contacto</h1>
			    </td>
			    </tr>
			    <tr>
			    <td style="color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 24px; padding: 20px 0 30px 0;">
			    <p style="margin: 0; text-align: justify;">Mensaje Enviado Por: '.$Nombre.' '.$Apellidos.'<br><br> E-mail: '.$correo.' <br><br> Teléfono:'.$telefono.' <br> <br> País: '.$paisEvaluar.' - Cargo: '.$cargoEvaluar.'</p>
